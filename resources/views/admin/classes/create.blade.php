...
<div class="container">
    <div class="form-header">
        ...
        <p>Add a new class to your school management system</p>
    </div>
    ...
    <div class="form-content">
        ...
        <form action="{{ route('admin.classes.store') }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="name"
                        value="{{ old('name') }}"
                        placeholder="e.g., 10th Grade, Class A, Grade 5"
                        required>
                    <div class="help-text">Enter a unique name for the class</div>
                    @error('name')
            ...
            <!-- Info Box -->
            <div class="info-box">
                Class names should be descriptive and unique to avoid confusion in your school system.
            </div>
        </form>
    </div>
</div>
